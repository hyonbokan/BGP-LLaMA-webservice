...
from fastapi_agent.config import REQUEST_TIMEOUT, get_provider
...
def _client(base_url: Optional[str], api_key: str) -> AsyncOpenAI:
    ...
    """
    return AsyncOpenAI(base_url=base_url, api_key=api_key, timeout=REQUEST_TIMEOUT, max_retries=0)
