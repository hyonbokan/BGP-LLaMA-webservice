...
def load_model():
    ...
    with model_lock:
        if model is None or tokenizer is None:
            try:
                ...
                # Optionally, you can disable caching to force incremental generation:
    ...
    # Setting timeout=60 to wait longer for tokens.
    streamer_factory = lambda: TextIteratorStreamer(
